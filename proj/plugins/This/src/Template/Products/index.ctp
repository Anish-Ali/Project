    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('relese') ?></th>
                <th scope="col"><?= $this->Paginator->sort('ram') ?></th>
                <th scope="col"><?= $this->Paginator->sort('processor') ?></th>
                <th scope="col"><?= $this->Paginator->sort('storage') ?></th>
                <th scope="col"><?= $this->Paginator->sort('gcard') ?></th>
